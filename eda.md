...
This dataset contains information about cars from different origins, including details such as name, fuel efficiency (mpg), cylinders, displacement, horsepower, weight, acceleration and model year.

The cars in the dataset are from the period 1970–1982, making these insights particularly relevant for sellers of vintage vehicles.
...
- Recommend high-performance cars for customers interested in power
- Recommend fuel-efficient cars for environment- or cost-conscious buyers
- Highlight trade-offs between performance and economy
- Tailor recommendations based on customer preferences

These insights are also reflected in the MCP tools implemented in this project, which are designed to support data-driven sales recommendations.